...
sudo scutil --set ComputerName "idefix"
sudo scutil --set HostName "idefix"
sudo scutil --set LocalHostName "idefix"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "idefix"
...
defaults write com.apple.mail NSUserKeyEquivalents --add "Send" "@\U21a9"
